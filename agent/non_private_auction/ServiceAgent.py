...
class ServiceAgent(Agent):
    def __init__(self, id, name, type,
        ...
        self.aggProcessingMap = {
            ...
            2: self.execute_orders   # Execute or move to next pair based on client action
        }
    ...
    def execute_orders(self, currentTime):
        ...
        if self.current_buy_order_status is not None and self.current_sell_order_status is not None:
            ...
            if self.current_buy_order_status and self.current_sell_order_status:
                ...
                self.execute_match(self.current_buy_order, self.current_sell_order)
        ...
        # Once the current pair is processed, move back to matching
        self.match_orders(currentTime)

    def execute_match(self, buy_order, sell_order):
        self.executed_orders += 2
        buy_order_client = buy_order[1]
        sell_order_client = sell_order[1]
